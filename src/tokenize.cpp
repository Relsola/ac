...
static bool is_keyword(Token *tok) {
  static char *kw[] = {
      "return", "if",       "else",   "for",   "while",   "void",   "short",    "int",      "long",
      "char",   "sizeof",   "struct", "union", "typedef", "_Bool",  "enum",     "static",   "goto",
      "break",  "continue", "switch", "case",  "default", "extern", "_Alignof", "_Alignas", "do",
  };
